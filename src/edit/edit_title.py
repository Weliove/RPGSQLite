...
from src.edit.edit_functions import get_text_data
...
class EditTitle(ttk.Frame):
    ...
    def edit_entity(self):
        ...
        self.interface(name) if not edit_title else popup_showinfo(edit_title)

    def interface(self, name):
        new_title = get_entity(name, 'titles')
        self.show_interface(new_title, 'titles')
